...
<a href="staffLogin.php">Home</a>
  ...
  <hr size=4 color=black />
   ...
   if(isset($_POST['sub1']))
   {
        ...
        $r="class_".$_POST['cls'];
        $localpath=$path."/Md_Sadik_Hussain_School_Management_System/Project/Assignment/".$r."/student/science/".$filename;
    ...
    if(isset($_POST['sub2'])) 
   {
        $path=$_SERVER['DOCUMENT_ROOT'];
         $r="class_".$_POST['cls'];
        $localpath=$path."/Md_Sadik_Hussain_School_Management_System/Project/Assignment/".$r."/teacher/science";
