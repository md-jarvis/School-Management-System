...
<a href="staffLogin.php">Home</a>
  ...
  <h1 style="text-align: center;color: white; background-color: gray;">Math</h1> 
  <hr size=4 color=black />
    ...
    <fieldset>
        <legend align=center>Upload Assignment</legend>
         <table align=center>
         <tr><td>For Class:</td><td><input type="number" name="cls" max="10" min="6"  /></td></tr>
   ...
   if(isset($_POST['sub1']))
   {
        ...
        $r="class_".$_POST['cls'];
        $localpath=$path."/Md_Sadik_Hussain_School_Management_System/Project/Assignment/".$r."/student/math/".$filename;
    ...
    if(isset($_POST['sub2'])) 
   {
        $path=$_SERVER['DOCUMENT_ROOT'];
        $r="class_".$_POST['cls'];
        $localpath=$path."/Md_Sadik_Hussain_School_Management_System/Project/Assignment/".$r."/teacher/math";
