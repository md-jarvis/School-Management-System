...
$db="class_".$r[1];
   ...
   if(isset($_POST['sub1']))
   {
        ...
        $localpath=$path."/Md_Sadik_Hussain_School_Management_System/Project/Assignment/".$db."/teacher/hindi/".$filename;
   ...
   {
        $path=$_SERVER['DOCUMENT_ROOT'];
        $localpath=$path."/Md_Sadik_Hussain_School_Management_System/Project/Assignment/".$db."/student/hindi";
