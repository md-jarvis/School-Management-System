...
<a href="studentLogin.php">Home</a>
  ...
  <h1 style="text-align: center;color: white; background-color: gray;">Science</h1> 
...
$db="class_".$r[1];
   ...
   if(isset($_POST['sub1']))
   {
        ...
        $localpath=$path."/Md_Sadik_Hussain_School_Management_System/Project/Assignment/".$db."/teacher/science/".$filename;
   ...
   {
        $path=$_SERVER['DOCUMENT_ROOT'];
        $localpath=$path."/Md_Sadik_Hussain_School_Management_System/Project/Assignment/".$db."/student/science";
